...
#ifndef BASLER_PYLON_BASLERCAMERA123CAMERAPARAMS_H
#define BASLER_PYLON_BASLERCAMERA123CAMERAPARAMS_H
...
namespace BaslerCamera123CameraParams_Params
{
    ...
    {
        BslUSBSpeedMode_HighSpeed,  //!< Applies to: acA1920-155uc
        BslUSBSpeedMode_SuperSpeed  //!< Applies to: acA1920-155uc
    };
    ...
    {
        DeviceTemperatureSelector_Todo  //!< TODO - Applies to: acA1920-155uc
    };
    ...
    enum LightSourcePresetEnums
    {
        ...
        LightSourcePreset_Off,  //!< Applies to: acA1920-155uc
    ...
    enum TriggerSourceEnums
    {
        ...
        TriggerSource_SoftwareSignal1,  //!< Applies to: acA1920-155uc
        TriggerSource_SoftwareSignal2  //!< Applies to: acA1920-155uc
    };

    //! Valid values for UserDefinedValueSelector
    enum UserDefinedValueSelectorEnums
    {
        UserDefinedValueSelector_Value1,  //!< Applies to: acA1920-155uc
        UserDefinedValueSelector_Value2,  //!< Applies to: acA1920-155uc
        UserDefinedValueSelector_Value3,  //!< Applies to: acA1920-155uc
        UserDefinedValueSelector_Value4,  //!< Applies to: acA1920-155uc
        UserDefinedValueSelector_Value5  //!< Applies to: acA1920-155uc
    };
    ...
    //**************************************************************************************************
    // Parameter class BaslerCamera123CameraParams
    //**************************************************************************************************
    ...
    acA1920-155uc 106591-14;U;acA1920_155u;V0.2-2;1
    */
    class BaslerCamera123CameraParams
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        //! \cond HIDE_CLASS_METHODS
            ...
            //! Constructor
            BaslerCamera123CameraParams(void);
    ...
    private:
        class BaslerCamera123CameraParams_Data;
        BaslerCamera123CameraParams_Data* m_pData;
    ...
    */
    ...
    //@{
    /*!
        \brief  Applies to: acA1920-155uc
    ...
    */
    ...
    //@}
        ...
        //! \cond HIDE_CLASS_METHODS
            ...
            BaslerCamera123CameraParams(BaslerCamera123CameraParams&);

            //! not implemented assignment operator
            BaslerCamera123CameraParams& operator=(BaslerCamera123CameraParams&);
...
#endif // BASLER_PYLON_BASLERCAMERA123CAMERAPARAMS_H