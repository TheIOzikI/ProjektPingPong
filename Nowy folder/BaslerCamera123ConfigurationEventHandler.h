...
#ifndef INCLUDED_BASLERCAMERA123FILE_H_27473547
#define INCLUDED_BASLERCAMERA123FILE_H_27473547
...
namespace Pylon123
{
    ...
    /**
    \class  BaslerCamera123ConfigurationEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnAttach( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnAttached( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDetach( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDetached( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDestroy( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDestroyed( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnOpen( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnOpened( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnClose( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnClosed( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStart( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStarted( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStop( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStopped( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabError( BaslerCamera123& camera, const char* errorMessage)
        {
            PYLON_UNUSED(&camera);
        ...
        */
        virtual void OnCameraDeviceRemoved( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnConfigurationRegistered( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnConfigurationDeregistered( BaslerCamera123& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        */
        ...
        /// Create.
        BaslerCamera123ConfigurationEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        BaslerCamera123ConfigurationEventHandler(const BaslerCamera123ConfigurationEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        BaslerCamera123ConfigurationEventHandler& operator=(const BaslerCamera123ConfigurationEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~BaslerCamera123ConfigurationEventHandler()
        {
...
#endif /* INCLUDED_BASLERCAMERA123FILE_H_27473547 */