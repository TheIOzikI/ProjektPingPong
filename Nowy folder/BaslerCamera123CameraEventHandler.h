...
#ifndef INCLUDED_BASLERCAMERA123FILE_H_03474787
#define INCLUDED_BASLERCAMERA123FILE_H_03474787
...
namespace Pylon123
{
    ...
    /**
    \class  BaslerCamera123CameraEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnCameraEvent( BaslerCamera123& camera, intptr_t userProvidedId, GENAPI_NAMESPACE::INode* pNode)
        {
            PYLON_UNUSED(&camera);
        ...
        \param[in]  userProvidedId  This ID is passed as a parameter in BaslerCamera123CameraEventHandler::OnCameraEvent and can be used to distinguish between different events.
        ...
        */
        virtual void OnCameraEventHandlerRegistered( BaslerCamera123& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
            PYLON_UNUSED(&camera);
        ...
        \threading
            This method is called inside the lock of the camera event handler registry.
        */
        virtual void OnCameraEventHandlerDeregistered( BaslerCamera123& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
            PYLON_UNUSED(&camera);
            PYLON_UNUSED(nodeName);
            PYLON_UNUSED(userProvidedId);
        ...
        */
        ...
        /// Create.
        BaslerCamera123CameraEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        BaslerCamera123CameraEventHandler(const BaslerCamera123CameraEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        BaslerCamera123CameraEventHandler& operator=(const BaslerCamera123CameraEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~BaslerCamera123CameraEventHandler()
        {
...
#endif /* INCLUDED_BASLERCAMERA123FILE_H_03474787 */