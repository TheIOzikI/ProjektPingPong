...
#ifndef INCLUDED_RIGHTFILE_H_03474787
#define INCLUDED_RIGHTFILE_H_03474787
...
namespace Pylon
{
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnCameraEvent( RIGHT& camera, intptr_t userProvidedId, GENAPI_NAMESPACE::INode* pNode)
        {
            PYLON_UNUSED(&camera);
        ...
        \param[in]  userProvidedId  This ID is passed as a parameter in RIGHTCameraEventHandler::OnCameraEvent and can be used to distinguish between different events.
        ...
        */
        virtual void OnCameraEventHandlerRegistered( RIGHT& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
            PYLON_UNUSED(&camera);
        ...
        \threading
            This method is called inside the lock of the camera event handler registry.
        */
        virtual void OnCameraEventHandlerDeregistered( RIGHT& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
            PYLON_UNUSED(&camera);
            PYLON_UNUSED(nodeName);
            PYLON_UNUSED(userProvidedId);
        ...
        */
        ...
        /// Create.
        RIGHTCameraEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        RIGHTCameraEventHandler(const RIGHTCameraEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        RIGHTCameraEventHandler& operator=(const RIGHTCameraEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~RIGHTCameraEventHandler()
        {
...
#endif /* INCLUDED_RIGHTFILE_H_03474787 */