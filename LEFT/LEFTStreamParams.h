...
#ifndef BASLER_PYLON_LEFTSTREAMPARAMS_H
#define BASLER_PYLON_LEFTSTREAMPARAMS_H
...
namespace Pylon
{
namespace LEFTStreamParams_Params
{
    //**************************************************************************************************
    // Enumerations
    //**************************************************************************************************
    ...
    //**************************************************************************************************
    // Parameter class LEFTStreamParams
    //**************************************************************************************************
    ...
    */
    ...
    private:
        class LEFTStreamParams_Data;
        LEFTStreamParams_Data* m_pData;
    ...
    */
    ...
    //@}
        ...
        //! \cond HIDE_CLASS_METHODS
            ...
            LEFTStreamParams(LEFTStreamParams&);

            //! not implemented assignment operator
            LEFTStreamParams& operator=(LEFTStreamParams&);
    ...
    //! \endcond
    //**************************************************************************************************
    // Parameter class LEFTStreamParams implementation
    //**************************************************************************************************
    ...
    ///////////////////////////////////////////////////////////////////////////
    //
    class LEFTStreamParams::LEFTStreamParams_Data
    {
    public:
    ...
    ///////////////////////////////////////////////////////////////////////////
    //
    inline LEFTStreamParams::LEFTStreamParams(void)
        : m_pData(new LEFTStreamParams_Data())
    ...
    ///////////////////////////////////////////////////////////////////////////
    //
    inline void LEFTStreamParams::_Initialize(GENAPI_NAMESPACE::INodeMap* pNodeMap)
    {
...
#endif // BASLER_PYLON_LEFTSTREAMPARAMS_H