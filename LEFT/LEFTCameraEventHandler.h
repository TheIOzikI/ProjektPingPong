...
#ifndef INCLUDED_LEFTFILE_H_03474787
#define INCLUDED_LEFTFILE_H_03474787
...
namespace Pylon
{
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnCameraEvent( LEFT& camera, intptr_t userProvidedId, GENAPI_NAMESPACE::INode* pNode)
        {
            PYLON_UNUSED(&camera);
        ...
        \param[in]  userProvidedId  This ID is passed as a parameter in LEFTCameraEventHandler::OnCameraEvent and can be used to distinguish between different events.
        ...
        */
        virtual void OnCameraEventHandlerRegistered( LEFT& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
            PYLON_UNUSED(&camera);
        ...
        \threading
            This method is called inside the lock of the camera event handler registry.
        */
        virtual void OnCameraEventHandlerDeregistered( LEFT& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
            PYLON_UNUSED(&camera);
            PYLON_UNUSED(nodeName);
            PYLON_UNUSED(userProvidedId);
        ...
        */
        ...
        /// Create.
        LEFTCameraEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        LEFTCameraEventHandler(const LEFTCameraEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        LEFTCameraEventHandler& operator=(const LEFTCameraEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~LEFTCameraEventHandler()
        {
...
#endif /* INCLUDED_LEFTFILE_H_03474787 */